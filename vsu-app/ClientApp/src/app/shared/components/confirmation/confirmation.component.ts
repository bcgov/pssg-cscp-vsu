...
export class ConfirmationComponent implements OnInit {
  ...
  ngOnInit() {
    if (this.formType === ApplicationType.NOTIFICATION) {
      ...
      this.confirmationMessage =
        'Thank you for for submitting a Victim Travel Fund Application to the Victim Safety Unit.';
    } else if (this.formType === ApplicationType.TRAVEL_REIMBURSEMENT) {
      //Please write down the following number for future reference:
      this.confirmationMessage =
        'Thank you for submitting a Victim Travel Fund Reimbursement Form to the Victim Safety Unit.';
    }
  }
  ...
  returnToVSUHome() {
    window.location.href =
      'https://www2.gov.bc.ca/gov/content/justice/criminal-justice/bcs-criminal-justice-system/if-you-are-a-victim-of-a-crime/victim-of-crime/victim-notification';
  }
}
