...
namespace DataverseModel
{
	...
	public partial class ActivityPointer : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.ActivityMimeAttachment> Activity_Pointer_Activity_Mime_Attachment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.ActivityMimeAttachment>("activity_pointer_activity_mime_attachment", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.ActivityMimeAttachment>("activity_pointer_activity_mime_attachment", null, value);
			}
		}
		...
		/// <summary>
		/// N:1 vsd_court_ActivityPointers
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("vsd_court_ActivityPointers")]
		public DataverseModel.VSd_Court VSd_Court_ActivityPointers
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataverseModel.VSd_Court>("vsd_court_ActivityPointers", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataverseModel.VSd_Court>("vsd_court_ActivityPointers", null, value);
			}
		}
