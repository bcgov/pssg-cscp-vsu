...
namespace DataverseModel
{
	...
	public enum Email_StatusCode
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Canceled", 7, "#666666")]
		Canceled = 5,
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Failed", 1, "#ea0600")]
		Failed = 8,
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Received", 4, "#358717")]
		Received = 4,
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Sent", 3, "#358717")]
		Sent = 3,
	}
	
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum Email_VSd_Cpu_CorrespondenceType
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Application Submission", 1, "#0000ff")]
		ApplicationSubmission = 100000001,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Contract Related Correspondence", 0, "#0000ff")]
		ContractRelatedCorrespondence = 100000000,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("General Inquiry", 2, "#0000ff")]
		GeneralInquiry = 100000002,
	}
	
	/// <summary>
	/// Status flag to track the status of the uploading attachments to SharePoint,.
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum Email_VSd_UploadStatus
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Unprocessed", 0, "#0000ff")]
		Unprocessed = 100000000,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadataAttribute("Uploaded", 1, "#0000ff")]
		Uploaded = 100000001,
	}
	...
	public partial class Email : Microsoft.Xrm.Sdk.Entity
	{
		...
		public partial class Fields
		{
			...
			public const string VSd_Court_Emails = "vsd_court_Emails";
			public const string VSd_Cpu_CorrespondenceType = "vsd_cpu_correspondencetype";
			public const string VSd_Cpu_CorrespondenceTypeName = "vsd_cpu_correspondencetypename";
			public const string VSd_HasUnresolvedContact = "vsd_hasunresolvedcontact";
			public const string VSd_HasUnresolvedContactName = "vsd_hasunresolvedcontactname";
			public const string VSd_InvoiceFlag = "vsd_invoiceflag";
			public const string VSd_InvoiceFlagName = "vsd_invoiceflagname";
			public const string VSd_ParentCase = "vsd_parentcase";
			public const string VSd_ParentCaseName = "vsd_parentcasename";
			...
			public const string VSd_Reviewed = "vsd_reviewed";
			public const string VSd_ReviewedName = "vsd_reviewedname";
			...
			public const string VSd_UploadStatus = "vsd_uploadstatus";
			public const string VSd_UploadStatusName = "vsd_uploadstatusname";
		}
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_cpu_correspondencetype")]
		public virtual Email_VSd_Cpu_CorrespondenceType? VSd_Cpu_CorrespondenceType
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((Email_VSd_Cpu_CorrespondenceType?)(EntityOptionSetEnum.GetEnum(this, "vsd_cpu_correspondencetype")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("vsd_cpu_correspondencetype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_cpu_correspondencetypename")]
		public string VSd_Cpu_CorrespondenceTypeName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("vsd_cpu_correspondencetype"))
				{
					return this.FormattedValues["vsd_cpu_correspondencetype"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// Internal field for identifying if a contact exists in CRM fro case creation.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_hasunresolvedcontact")]
		public System.Nullable<bool> VSd_HasUnresolvedContact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("vsd_hasunresolvedcontact");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("vsd_hasunresolvedcontact", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_hasunresolvedcontactname")]
		public string VSd_HasUnresolvedContactName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("vsd_hasunresolvedcontact"))
				{
					return this.FormattedValues["vsd_hasunresolvedcontact"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// (Internal): Used to determine if the attachment should be uploaded to an invoice..
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_invoiceflag")]
		public System.Nullable<bool> VSd_InvoiceFlag
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("vsd_invoiceflag");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("vsd_invoiceflag", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_invoiceflagname")]
		public string VSd_InvoiceFlagName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("vsd_invoiceflag"))
				{
					return this.FormattedValues["vsd_invoiceflag"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_parentcase")]
		public Microsoft.Xrm.Sdk.EntityReference VSd_ParentCase
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("vsd_parentcase");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("vsd_parentcase", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_parentcasename")]
		public string VSd_ParentCaseName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("vsd_parentcase"))
				{
					return this.FormattedValues["vsd_parentcase"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// Unique identifier for Program associated with Email.
		/// </summary>
		...
		/// <summary>
		/// Unique identifier for Request associated with Email.
		/// </summary>
		...
		/// <summary>
		/// A flag set by the staff to "review" emails. removing the records from dashboard views.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_reviewed")]
		public System.Nullable<bool> VSd_Reviewed
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("vsd_reviewed");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("vsd_reviewed", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_reviewedname")]
		public string VSd_ReviewedName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("vsd_reviewed"))
				{
					return this.FormattedValues["vsd_reviewed"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// A look-up field to allow users to tie email's with a defined tag.
		/// </summary>
		...
		/// <summary>
		/// A lookup to the tag entity linking an email to a defined tag.
		/// </summary>
		...
		/// Status flag to track the status of the uploading attachments to SharePoint,.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_uploadstatus")]
		public virtual Email_VSd_UploadStatus? VSd_UploadStatus
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((Email_VSd_UploadStatus?)(EntityOptionSetEnum.GetEnum(this, "vsd_uploadstatus")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("vsd_uploadstatus", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("vsd_uploadstatusname")]
		public string VSd_UploadStatusName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("vsd_uploadstatus"))
				{
					return this.FormattedValues["vsd_uploadstatus"];
				}
				else
				{
					return default(string);
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.ActivityMimeAttachment> Email_Activity_Mime_Attachment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.ActivityMimeAttachment>("email_activity_mime_attachment", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.ActivityMimeAttachment>("email_activity_mime_attachment", null, value);
			}
		}
		...
		/// <summary>
		/// N:1 vsd_court_Emails
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("vsd_court_Emails")]
		public DataverseModel.VSd_Court VSd_Court_Emails
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataverseModel.VSd_Court>("vsd_court_Emails", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataverseModel.VSd_Court>("vsd_court_Emails", null, value);
			}
		}
