...
namespace DataverseModel
{
	...
	public partial class TransactionCurrency : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.VSd_Participant> TransactionCurrency_VSd_Participant
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.VSd_Participant>("TransactionCurrency_vsd_participant", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.VSd_Participant>("TransactionCurrency_vsd_participant", null, value);
			}
		}
		
		/// <summary>
		/// 1:N TransactionCurrency_vsd_province
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("TransactionCurrency_vsd_province")]
		public System.Collections.Generic.IEnumerable<DataverseModel.VSd_Province> TransactionCurrency_VSd_Province
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.VSd_Province>("TransactionCurrency_vsd_province", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.VSd_Province>("TransactionCurrency_vsd_province", null, value);
			}
		}
