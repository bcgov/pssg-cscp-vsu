...
namespace DataverseModel
{
	...
	public partial class ActivityParty : Microsoft.Xrm.Sdk.Entity
	{
		...
		/// <summary>
		/// N:1 vsd_court_ActivityParties
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("partyid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("vsd_court_ActivityParties")]
		public DataverseModel.VSd_Court VSd_Court_ActivityParties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataverseModel.VSd_Court>("vsd_court_ActivityParties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataverseModel.VSd_Court>("vsd_court_ActivityParties", null, value);
			}
		}
		
		/// <summary>
		/// N:1 vsd_participant_ActivityParties
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("partyid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("vsd_participant_ActivityParties")]
		public DataverseModel.VSd_Participant VSd_Participant_ActivityParties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataverseModel.VSd_Participant>("vsd_participant_ActivityParties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DataverseModel.VSd_Participant>("vsd_participant_ActivityParties", null, value);
			}
		}
