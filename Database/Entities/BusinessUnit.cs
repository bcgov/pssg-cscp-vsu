...
namespace DataverseModel
{
	...
	public partial class BusinessUnit : Microsoft.Xrm.Sdk.Entity
	{
		...
		/// <summary>
		/// 1:N business_unit_vsd_application
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("business_unit_vsd_application")]
		public System.Collections.Generic.IEnumerable<DataverseModel.VSd_Application> Business_Unit_VSd_Application
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.VSd_Application>("business_unit_vsd_application", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.VSd_Application>("business_unit_vsd_application", null, value);
			}
		}
		
		/// <summary>
		/// 1:N business_unit_vsd_applicationcourtinformation
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("business_unit_vsd_applicationcourtinformation")]
		public System.Collections.Generic.IEnumerable<DataverseModel.VSd_ApplicationCourtInformation> Business_Unit_VSd_ApplicationCourtInformation
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.VSd_ApplicationCourtInformation>("business_unit_vsd_applicationcourtinformation", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
