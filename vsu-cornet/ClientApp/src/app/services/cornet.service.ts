...
export class CornetService {
  ...
  getClients(parameters: IClientParameters): Observable<any> {
    ...
    return this.http
      .get<any>(`${this.apiUrl}/clients?${query_parameters}`, { headers: this.headers })
  ...
  getEvent(parameters: ICornetParameters): Observable<any> {
    ...
    let query_parameters = params.join('&');
    return this.http
      .get<any>(`${this.apiUrl}/event?${query_parameters}`, { headers: this.headers })
      .pipe(retry(3), catchError(this.handleError));
  }
  ...
  getAuthorityDocument(parameters: ICornetParameters): Observable<any> {
    ...
    let query_parameters = params.join('&');
    return this.http
      .get<any>(`${this.apiUrl}/authority-document?${query_parameters}`, { headers: this.headers })
      .pipe(retry(3), catchError(this.handleError));
  }
  ...
  getHearing(parameters: ICornetParameters): Observable<any> {
    ...
    let query_parameters = params.join('&');
    return this.http
      .get<any>(`${this.apiUrl}/hearing?${query_parameters}`, { headers: this.headers })
      .pipe(retry(3), catchError(this.handleError));
  }
  ...
  getKeyDate(parameters: ICornetParameters): Observable<any> {
    ...
    let query_parameters = params.join('&');
    return this.http
      .get<any>(`${this.apiUrl}/key-date?${query_parameters}`, { headers: this.headers })
      .pipe(retry(3), catchError(this.handleError));
  }
  ...
  getMovement(parameters: ICornetParameters): Observable<any> {
    ...
    let query_parameters = params.join('&');
    return this.http
      .get<any>(`${this.apiUrl}/movement?${query_parameters}`, { headers: this.headers })
      .pipe(retry(3), catchError(this.handleError));
  }
  ...
  getStateTransition(parameters: ICornetParameters): Observable<any> {
    ...
    let query_parameters = params.join('&');
    return this.http
      .get<any>(`${this.apiUrl}/state-transition?${query_parameters}`, { headers: this.headers })
      .pipe(retry(3), catchError(this.handleError));
  }
  ...
  getVictimContact(parameters: ICornetParameters): Observable<any> {
    ...
    let query_parameters = params.join('&');
    return this.http
      .get<any>(`${this.apiUrl}/victim-contact?${query_parameters}`, { headers: this.headers })
      .pipe(retry(3), catchError(this.handleError));
  }
