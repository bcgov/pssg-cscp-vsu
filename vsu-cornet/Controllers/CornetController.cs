...
namespace Gov.Cscp.Victims.Public.Controllers
{
    ...
    public class CornetController : Controller
    {
        ...
        [HttpGet("clients")]
        public async Task<IActionResult> GetClients(string search_type, string surname, string given1, string given2, string birth_year, string birth_year_range, string gender, string identifier_type, string identifier_text)
        {
            try
            {
                ...
                DynamicsResult result = await _cornetResultService.Get(endpointUrl);
